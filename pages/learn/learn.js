...
const FOUNDATION_LESSONS = [
  ...
  },
  {
    ...
    vocab: [
      ...
      { italian: 'il libro',      chinese: '（那本）书',        pronunciation: '伊尔 利布罗' },
      { italian: 'la borsa',      chinese: '（那个）包',        pronunciation: '拉 博尔萨' },
    ],
    grammar: '规律：名词以 -o 结尾通常是阳性（il libro），以 -a 结尾通常是阴性（la borsa）。以 -e 结尾需要记忆（il ristorante 阳性，la stazione 阴性）。复数：阳性 -o→-i（libri），阴性 -a→-e（borse）。冠词必须和名词性别、数匹配。',
    conjugation: null,
    exercise: {
  ...
  },
  {
    ...
    desc: '我的、你的、他的——表达所属关系',
    vocab: [
      { italian: 'mio / mia',       chinese: '我的（阳/阴）',    pronunciation: '米欧 / 米阿' },
      { italian: 'tuo / tua',       chinese: '你的（阳/阴）',    pronunciation: '图欧 / 图阿' },
      { italian: 'suo / sua',       chinese: '他的/她的（阳/阴）',pronunciation: '苏欧 / 苏阿' },
      { italian: 'nostro / nostra', chinese: '我们的（阳/阴）',  pronunciation: '诺斯特罗 / 诺斯特拉' },
      { italian: 'vostro / vostra', chinese: '你们的（阳/阴）',  pronunciation: '沃斯特罗 / 沃斯特拉' },
      { italian: 'loro',            chinese: '他们的（不变）',   pronunciation: '洛罗' },
    ],
    grammar: '物主代词要和所属的名词性别匹配，不是和主语匹配。例如：il mio libro（我的书，libro是阳性）/ la mia borsa（我的包，borsa是阴性）。家庭成员单数不用冠词：mio padre（我爸爸）/ mia madre（我妈妈），复数加冠词：i miei genitori（我的父母）。',
    conjugation: null,
    exercise: {
